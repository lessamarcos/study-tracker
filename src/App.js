...
import { Calendar, Clock, BookOpen, CheckSquare, TrendingUp, Plus, Trash2, FileText, Target, Award, BarChart3, Flame, Download, Edit2, Check, X } from 'lucide-react';
...
export default function StudyTracker() {
  ...
  const handleTopicSubmit = (e) => {
    ...
    if (editingTopic) {
      setTopics(prev => prev.map(t => t.id === editingTopic.id ? {...topicForm, id: t.id} : t));
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="bg-gray-800 border-b border-gray-700 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">
            📚 Tracker de Estudos
          </h1>
